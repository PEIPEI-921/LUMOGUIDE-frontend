...
class InviteSharePreviewDialog extends StatefulWidget {
  const InviteSharePreviewDialog({
    super.key,
  ...
  @override
  State<InviteSharePreviewDialog> createState() =>
      _InviteSharePreviewDialogState();
}

class _InviteSharePreviewDialogState extends State<InviteSharePreviewDialog> {
