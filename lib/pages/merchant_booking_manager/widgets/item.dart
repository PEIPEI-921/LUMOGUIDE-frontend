...
class MerchantBookItemWidget extends StatelessWidget {
  const MerchantBookItemWidget({super.key, required this.item});
  final MerchantReservation item;

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<MerchantBookingManagerController>();
            ...
            Column(
                  children: [
                    ...
                    Row(
                      children: [
                        CircleNetworkImage(
                          imageUrl: item.content?.firstPicture,
                          radius: 12.w,
                        ),
                        ...
                        Text(
                              MerchantShopTypeExt.fromId(
                                item.content?.typeId ?? 0,
                              ).title,
                              style: TextStyle(
