...
class PublishFacilityPage extends StatelessWidget {
  const PublishFacilityPage({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(PublishFacilityController());
    return IScaffold(
      appBar: IAppBar(title: '發布設施'.tr),
...
class _ImagesWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final controller = Get.find<PublishFacilityController>();
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
          children: [
            ...
            Text('設施圖片'.tr).fontSize(14.sp).textColor(AppColors.primaryText),
          ],
        ),
        10.w.verticalSpace,
        Obx(
