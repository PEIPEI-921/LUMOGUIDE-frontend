...
class TransportationListController extends GetxController
  ...
  onEditItem(GuidePublishTransportation item) async {
    if (item.isRead == 0) {
      item.isRead = 1;
      refreshItems();
    }
  ...
  onDeleteItem(GuidePublishTransportation item) async {
...
class TransportationListWidget extends StatelessWidget {
  const TransportationListWidget({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(TransportationListController());
...
class _Item extends StatelessWidget {
  ...
  final GuidePublishTransportation item;
