...
class MineTrialWidget extends StatelessWidget with UserStoreMixin {
  const MineTrialWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => !(userInfo.isFreeVip) || userInfo.inAudit
                      ...
                      children: [
                        Row(
                          children: [
                            Text(
                              '@d天免費試⽤'.trParams({
                                'd': userInfo.vipFreeDay.toString(),
                              }),
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16.sp,
