...
class BookingDetailsWidget extends StatelessWidget {
  ...
  List<Widget> _buildTypeSpecificFields(
      MerchantBookingDetailController controller) {
  ...
  List<Widget> _buildHotelFields(MerchantBookingDetailController controller) {
    return [
      if (controller.merchantInfo!.arrivalTime?.isNotEmpty == true)
        _DetailItem(
          label: '入住時間'.tr,
  ...
  List<Widget> _buildTicketFields(MerchantBookingDetailController controller) {
    return [
      _DetailItem(
        label: '人數'.tr,
        value: controller.merchantInfo!.number ?? '',
  ...
  List<Widget> _buildScenicFields(MerchantBookingDetailController controller) {
    return [
      if (controller.merchantInfo!.arrivalTime?.isNotEmpty == true)
        _DetailItem(
          label: '預計到達時間'.tr,
