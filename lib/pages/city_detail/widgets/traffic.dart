...
class CityDetailTrafficWidget extends StatelessWidget {
  const CityDetailTrafficWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return EasyRefresh(
      ...
      onRefresh: () async {
        await controller
            .onCategoryTabChanged(controller.trafficCategoryIndex.value);
      },
      child: Obx(() {
        final list = controller.trafficList;
        if (list.isEmpty) {
    ...
    return Column(
      ...
      children: [
        ...
        Column(
          ...
          onTap: () => controller.onTapTrafficItem(item),
          behavior: HitTestBehavior.opaque,
        );
  }
}
